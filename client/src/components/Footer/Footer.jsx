      ...
      <article className={styles.footer}>
          ...
          <section className={styles.footerTopLeft}>
            <section className={styles.footerContact}>
              ...
              <nav className={styles.footerList}>
                <Link to="tel:+1-888-963-8944" aria-label="Contact us by phone">
                  1-888-963-8944
                </Link>
                <Link to="mailto:bavovna19@gmail.com" aria-label="Contact us by email">
                  bavovna19@gmail.com
                </Link>
                <Link to="mailto:help@bavovna.space" aria-label="Contact us by email">
                  Contact Us
                </Link>
            ...
            <section className={styles.footerHelp}>
              <h3>Help</h3>
              <nav className={styles.footerList}>
                <Link to="/help/delivery" aria-label="Learn about delivery options">
                  Delivery information
                </Link>
                <Link to="/help/return" aria-label="Learn about return options">
                  Return information
                </Link>
                <Link to="/help/payment" aria-label="Learn about payment options">
                  Payment
                </Link>
        ...
        <section className={styles.footerBottom}>
          <section className={styles.footerBottomLeft}>
            <p className={styles.footerBottomItem}>© 2024 Bavovna | All Rights Reserved</p>
            <nav className={`${styles.footerBottomItem} ${styles.footerBottomCookies}`}>
