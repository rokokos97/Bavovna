...
import TextField from '../../../form/formFields/TextField/TextField';
import PhoneField from '../../../form/formFields/PhoneField/PhoneField';
const UserDataForm = () => {
  ...
  return (
    user && (
      <article className={styles.userDataForm} data-testid="UserDataForm">
        ...
        <form className={styles.userDataForm__userPersonalDataForm} onSubmit={formik.handleSubmit}>
