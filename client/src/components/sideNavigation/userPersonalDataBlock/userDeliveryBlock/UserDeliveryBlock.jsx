...
import UserDeliveryMethodsList from '../../../../pages/checkOutPage/checkOutPageDelivery/deliveryOptionsSection/userDeliveryMethodsList/UserDeliveryMethodsList';
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(
        updateUserData({
          ...user,
          deliveryAddress: [...user.deliveryAddress, newValues],
          currentDeliveryAddress: newValues._id,
        })
      );
      formik.resetForm({
        values: {
  ...
  return (
    user && (
      <div className={styles.userDeliveryBlock} data-testid="UserDeliveryBlock">
        <p className={styles.userDeliveryBlock__deliveryTitle}>delivery</p>
        <section className={styles.userDeliveryBlock__section}>
          <form className={styles.userDeliveryBlock__column} onSubmit={formik.handleSubmit}>
            <p className={styles.userDeliveryBlock__blockLabel}>Add new delivery method</p>
          ...
          <div className={styles.userDeliveryBlock__column}>
            <p className={styles.userDeliveryBlock__blockLabel}>Saved delivery method</p>
