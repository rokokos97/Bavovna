        ...
        <table className={styles.orderList__table}>
          ...
          <tbody className={styles.orderList__table_tbody}>
            {user.orders.map((order) => (
              <tr className={styles.orderList__table_tbody_tr} key={order._id}>
                <td>
                  <span className={styles.orderList__table_tbody_title}>order</span>
                  {`#${order._id}`}
                  <Link
                ...
                <td>
                  <span className={styles.orderList__table_tbody_title}>datum</span>
                  {order.date}
                </td>
                <td>
                  <span className={styles.orderList__table_tbody_title}>payment status</span>
                  {order.paymentStatus}
                </td>
                <td>
                  <span className={styles.orderList__table_tbody_title}>shipping status</span>
                ...
                <td className={styles.orderList__table_tbody_chevron}>
                  <Link to={`order/${order._id}`}>{<ChevronDown />}</Link>
                </td>
              </tr>
            ))}
          </tbody>
