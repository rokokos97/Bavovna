...
const CheckoutModal = ({ handleCloseModal }) => {
  ...
  const { itemName, discountPrice, itemColor, itemSize, itemImg, itemQuantity } = itemData;
  ...
  return (
    <section className={styles.checkout} data-testid="CheckoutModal">
      ...
      <div className={styles.checkoutContainer}>
        ...
        <div className={styles.checkoutContent}>
          ...
          <div className={styles.dataBlock}>
            ...
            <div className={styles.paramsBlock}>
              <span>Quantity:</span>
              <div className={styles.quantityBlock}>{itemQuantity}</div>
            </div>
          </div>
        </div>
      </div>
      <div className={styles.btnContainer}>
        ...
        <Link to="/cart" className={styles.checkoutBtn} onClick={handleCloseModal}>
          <span>Check out</span>
        </Link>
      </div>
    </section>
