  ...
  return (
    <div className={styles.deleteUserModal} data-testid="PaymentSuccessModal">
      ...
      <section className={styles.deleteUserModal__contentBlock}>
        <h2 className={styles.deleteUserModal__title}>Are you sure you want to delete your account?</h2>
        <p className={styles.deleteUserModal__text}>
          Deleting your account is permanent and cannot be undone. All your data,<br/>
          including personal information, preferences, and activity history, will be<br/>
          permanently erased from our system.</p>
        <div
          className={styles.deleteUserModal__buttons}>
          <button
