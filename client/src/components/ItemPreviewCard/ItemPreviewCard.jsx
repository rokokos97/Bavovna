    ...
    item && (
      ...
      >
        ...
        {item.status && (
          ...
          >
            <div className={styles.itemPreviewCard__statusText}>{item.status}</div>
          </div>
        )}
        <div className={styles.itemPreviewCard__heart} onClick={() => handleIsFavorite()}>
        ...
        >
          ...
          <p
            className={
              discountPrice === 0 ? styles.itemPreviewCard__price : styles.itemPreviewCard__discount
            }
          >
