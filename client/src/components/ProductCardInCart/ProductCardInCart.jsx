    ...
    <div className={styles.productCardInCart} data-testid="ProductCardInCart" type={type}>
      ...
      <div className={styles.productCardInCart__infoBlock}>
        <section className={styles.productCardInCart__namePriceBlock}>
          ...
          <p
            className={
              item.discountPrice === item.itemPrice
                ? styles.productCardInCart__price
                : styles.productCardInCart__discount
            }
          >
            <span>{item.itemPrice} ₴</span>
            <span>{item.discountPrice === item.itemPrice ? '' : item.discountPrice + ' ₴'}</span>
          </p>
        </section>
        <section className={styles.productCardInCart__sizeColorQuantityDeleteBlock}>
          <div className={styles.productCardInCart__sizeColorQuantityBlock}>
            ...
            <div className={styles.productCardInCart__colorBlock}>
              ...
              <div
                ...
                className={styles.productCardInCart__colorRectangle}
              ></div>
            </div>
            <div className={styles.productCardInCart__quantityBlock}>
              <p>quantity:</p>
              <div className={styles.productCardInCart__quantity}>
                <button onClick={handleQuantityLess} className={styles.productCardInCart__button}>
                  -
                </button>
                <p>{item.itemQuantity}</p>
                <button onClick={handleQuantityAdd} className={styles.productCardInCart__button}>
                  +
                </button>
              </div>
            </div>
          ...
          <div className={styles.productCardInCart__buttonBlock}>
            <button onClick={handleItemDelete} className={styles.productCardInCart__buttonDelete}>
              <DeleteIcon />
            </button>
          </div>
        </section>
