...
const NewCollectionBlock = () => {
  return (
    <article
      className={styles.newCollectionBlock}
      data-testid='NewCollectionBlock'
    >
      ...
      <section className={styles.newCollectionBlock__section}>
        <h1 className={styles.newCollectionBlock__title1}>new collection</h1>
        <p className={styles.newCollectionBlock__text}>
          Together, we can transform the way we consume and create a brighter,
