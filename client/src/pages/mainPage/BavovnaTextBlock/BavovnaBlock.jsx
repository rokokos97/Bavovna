  ...
  return (
    <article className={styles.bavovnaBlock} data-testid="BavovnaBlock">
      ...
      <p className={styles.bavovnaBlock__content}>
        We are dedicated to bringing you a wide range of sustainable products that help reduce your
        ecological footprint without compromising on quality or style.
      </p>
      <Link to="/shop" className={styles.bavovnaBlock__button}>
        <span>shop now</span>
      </Link>
    </article>
  );
