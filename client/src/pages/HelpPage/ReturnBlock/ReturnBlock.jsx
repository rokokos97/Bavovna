      ...
      <div className={styles.description}>
        <div className={styles.detailsBlock}>
          ...
          <p className={styles.detailsParagraph}>
            At BAVOVNA, we value your satisfaction and strive to provide you
            with high-quality products. If, for any reason, you are not
            completely satisfied with your purchase, our hassle-free return
            policy ensures a smooth and convenient process for returns.
          </p>
        </div>
        <div className={styles.detailsDropdown}>
          <Dropdown
            ...
            inner={
              <p>
                If the product is returned due to a change of mind or any reason
                other than poor quality, a return can be initiated within 30
        ...
        <div className={styles.detailsDropdown}>
          <Dropdown
            ...
            inner={
              <p>
                In the rare case of receiving a defective or poor-quality
                product, please contact our customer service team immediately
            ...
            inner={
              <div className={styles.detailsParagraph}>
                ...
                <ol className={styles.detailsNumberedList}>
                  ...
                  <li>
                    Follow the instructions to initiate the return process.
                  </li>
                </ol>
            ...
            inner={
              <div className={styles.detailsParagraph}>
                ...
                <ul className={styles.detailsList}>
                  ...
                  <li>
                    Attach the return label provided during the online return
                    process.
                  </li>
                ...
                <p>In-Store Return:</p>
                <p>
                  For local customers, returns can be made in person at our
                  physical store locations. Please bring your order confirmation
                  and the item in its original condition.
                </p>
              </div>
            }
          />
        ...
        <div className={styles.detailsBlock}>
          ...
          <p className={styles.detailsParagraph}>
            Refunds will be processed within 30 days of receiving the returned
        ...
        <div className={styles.detailsBlock}>
          ...
          <p className={styles.detailsParagraph}>
            The refund amount will be reflected in your account within 30
            business days, depending on your card issuer`s policies. Refunds for
            online payment methods will be processed within 14 days.
          </p>
        </div>
      </div>
    </>
