    ...
    <div className={styles.aboutBlock} data-testid="AboutBlock">
      ...
      <div className={styles.description}>
        ...
        <p className={styles.modalCookies__text}>
          BAVOVNA is a women&#39;s clothing brand that cares about the health and comfort of its
          customers. All products of this brand are made from organic cotton, which is grown without
          chemical fertilizers and pesticides. Thus, BAVOVNA clothes are environmentally friendly
          and safe for health.
        </p>
      </div>
    </div>
