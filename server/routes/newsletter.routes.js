...
router.post('/', async (req, res) => {
  ...
  try {
            ...
            <body>
              <div class="container">
                ...
                <div class="content">
                  <h2>HELLO!</h2>
                  <p>
                    Thank you for signing up with BAVOVNA newsletter. Use this promo code for your first order at our shop
                  </p>
                  <p class="promo-code">
                    BAVOVNA10
                  </p>
              ...
              <html lang="en">
                ...
                <body>
                  <table role="presentation" style="background-color: #FAFAFA; ">
                    <tr>
                      <td class="header">
                        <a class="logo" href="https://anvovab.space" target="_blank" rel="noreferrer">
                    ...
                    <tr>
                      <td style="padding: 24px; font-family: 'Poppins', sans-serif;">
                        <h2 style="font-size: 16px; font-weight: 500; text-transform: uppercase; margin-bottom: 20px; line-height: 1.2;">Trending Now: Sustainable Fashion</h2>
                        <p style="font-size: 16px; font-weight: 400; line-height: 1.2;">
                          At BAVOVNA STORE, we’re committed to sustainability. Check out our eco-friendly collection made from organic and recycled materials. Look great and feel good about making a positive impact on the planet.
                        </p>
                        <ul style="font-size: 16px; font-weight: 400; line-height: 1.2;">
                          <li>Organic Cotton Tees: Soft, comfortable, and environmentally friendly.</li>
                          <li>Recycled Polyester Activewear: Durable and perfect for your active lifestyle.</li>
                          <li>Eco-Friendly Denim: Stylish jeans made with less water and fewer chemicals.</li>
                        </ul>
                        <a href="https://anvovab.space"
    ...
    setTimeout(
      await transporter.sendMail(mailOptionsNewsletter, function(error, info) {
        if (error) {
          return res.status(500).json({
            response: {
              code: 500,
