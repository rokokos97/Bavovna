...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
            <article style="background-color: #FAFAFA; width: 600px;">
                <section style="height: 72px; padding: 8px; display: flex; align-items: center; justify-content:center;" >
                ...
                <section style="padding: 24px;" >
                    ...
                    <p style="font-size: 16px; font-weight: 400; font-family: 'Poppins',sans-serif; line-height: 1.2;">
                        Thank you for signing up with BAVOVNA newsletter.</br>
                        Use this promo code for your first order at our shop
                    </p>
                    <p style="display: inline-block; margin-left: 190px; font-size: 16px; font-weight: 600; font-family: 'Poppins', sans-serif; text-transform: uppercase; padding: 16px 24px; background-color: #040404; color: #fafafa; text-decoration: none;">
                        BAVOVNA10
                    </p>
                    ...
                    <p style="font-size: 16px; font-weight: 400; font-family: 'Poppins', sans-serif; line-height: 1.4;">
                        Best regards,<br/>
                        <b>BAVOVNA</b> Support Team
                    </p>
                </section>
                <section style="background-color: #040404; display: flex; flex-direction: column; gap: 16px; align-items: center; justify-content: center; padding: 24px;">
                <div>
