            ...
            <article style="background-color: #FAFAFA; width: 600px;">
                ...
                <section style="padding: 24px;" >
                    ...
                    <p style="font-size: 16px; font-weight: 400; font-family: 'Poppins',sans-serif; line-height: 1.2;">
                        ...
                        on our website. To proceed with changing your password, please</br>
                        click  below
                    </p>
                    <a href="${resetPasswordURL}" style="display: inline-block; margin-left: 190px; font-size: 16px; font-weight: 600; font-family: 'Poppins', sans-serif; text-transform: uppercase; padding: 16px 24px; background-color: #040404; color: #fafafa; text-decoration: none;">
                        reset password
                    </a>
                    <p style="font-size: 16px; font-weight: 400; font-family: 'Poppins', sans-serif; line-height: 1.4; margin-bottom: 32px;">
                        If you did not create an account with us, please disregard this email.<br/>
