              ...
              <html lang="en">
                ...
                <body>
                  <table role="presentation">
                    ...
                    <tr>
                      <td class="content">
                        <h2 class="contetnt__text">Trending Now: Sustainable Fashion</h2>
                        <p class="contetnt__text">
                        ...
                        <ul>
                          <li class="contetnt__text">Organic Cotton Tees: Soft, comfortable, and environmentally friendly.</li>
                          <li class="contetnt__text">Recycled Polyester Activewear: Durable and perfect for your active lifestyle.</li>
                          <li class="contetnt__text">Eco-Friendly Denim: Stylish jeans made with less water and fewer chemicals.</li>
                        </ul>
                        <div class="content__wrapper">
                          <a class="content__button" href="https://anvovab.space">
                           shop now
                          </a>
                        </div>
                        <p class="contetnt__text">
                    ...
                    <tr>
                      <td class="footer">
                        <div class="social-links">
                            ...
                            <a class="social-links__link" href="https://www.facebook.com/" target="_blank" rel="noreferrer" aria-label="Follow us on Facebook">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="social-links__link" href="https://www.tiktok.com/" target="_blank" rel="noreferrer" aria-label="Follow us on TikTok">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
